...
exports.rejectWithdrawalRequest = exports.validateWithdrawalRequest = exports.requestWithdrawal = exports.createTransaction = void 0;
...
const withdrawRequestModel_1 = __importDefault(require("../../models/withdrawRequestModel"));
const createTransaction = (request) => __awaiter(void 0, void 0, void 0, function* () {
    let transaction = new TransactionModel_1.default({
        ...
        campaign: request === null || request === void 0 ? void 0 : request.campaignId,
    ...
    let user = yield userModel_1.default.findById({ _id: "userId" });
    if (!user)
        throw new Error("Invalid User");
    let campaign = yield campaignModel_1.default.findById({ campaign: "campaignId" });
    if (!campaign)
...
const requestWithdrawal = (request) => __awaiter(void 0, void 0, void 0, function* () {
    let campaign = yield campaignModel_1.default.findById({ campaign: "campaignId" });
    if (!campaign)
        throw new Error("Invalid CampaignId");
    ...
    for (const user in campaign.signatories) {
        allowedSigners.push(new interfaces_1.Signer(user));
    }
    let withdrawRequest = new withdrawRequestModel_1.default({
...
const validateWithdrawalRequest = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    //Get a request
    ...
    let withdrawRequest = yield withdrawRequestModel_1.default.findById(requestId);
    if (!withdrawRequest)
...
const rejectWithdrawalRequest = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { requestId } = req.params;
    const { userId } = req.body;
    //validate request Id
    if (!requestId)
